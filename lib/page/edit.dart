...
class _EditPageState extends State<EditPage> {
  ...
  Future<bool> _onWillPop() async {
    ...
    return await showDialog(
            ...
            builder: (context) => AlertDialog(
                  ...
                  content: Text('Do you really want to discard your current changes?'),
                  actions: <Widget>[
                    TextButton(
                      child: Text('Cancel'),
                      onPressed: () {
 ...
 oldFile.deleteSync();
  ...
  Widget build(BuildContext context) {
    if (_syntaxHighlighterBase.accentColor == null) _syntaxHighlighterBase.init(Theme.of(context).accentColor);
              ...
              if (previewFeatureEnabled)
                ((PrefService.getBool('editor_mode_switcher'))
                    ? Switch(
                        ...
                        onChanged: (value) {
                          PrefService.setBool('editor_mode_switcher_is_preview', value);
                          setState(() {
                    ...
                    case 'removeTag':
                      ...
                      bool remove = await showDialog(
                          ...
                          builder: (context) => AlertDialog(
                                ...
                                content: Text('Do you want to remove the tag "$tag" from this note?'),
                                actions: <Widget>[
                                  TextButton(
                                    child: Text('Cancel'),
                                    onPressed: () {
